...
void graphicsLayerActorSetAnchorPoint(GraphicsLayerActor*, gfloat, gfloat, gfloat);
void graphicsLayerActorGetAnchorPoint(GraphicsLayerActor*, gfloat*, gfloat*, gfloat*);
void graphicsLayerActorSetScrollPosition(GraphicsLayerActor*, gfloat, gfloat);

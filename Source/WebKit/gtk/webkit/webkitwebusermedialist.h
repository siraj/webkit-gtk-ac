...
WEBKIT_API guint
webkit_web_user_media_list_get_audio_length    (WebKitWebUserMediaList *list);

WEBKIT_API guint
webkit_web_user_media_list_get_video_length    (WebKitWebUserMediaList *list);

WEBKIT_API const gchar *
webkit_web_user_media_list_get_audio_item_name (WebKitWebUserMediaList *list,
                                                guint index);
WEBKIT_API const gchar *
webkit_web_user_media_list_get_video_item_name (WebKitWebUserMediaList *list,
                                                guint index);

WEBKIT_API gboolean
webkit_web_user_media_list_get_audio_item_selected(WebKitWebUserMediaList *list,
                                             guint index);
WEBKIT_API gboolean
webkit_web_user_media_list_get_video_item_selected(WebKitWebUserMediaList *list,
                                             guint index);

WEBKIT_API void
webkit_web_user_media_list_select_video_item (WebKitWebUserMediaList *list,
                                              guint index);

WEBKIT_API void
webkit_web_user_media_list_select_audio_item (WebKitWebUserMediaList *list,
                                             guint index);
